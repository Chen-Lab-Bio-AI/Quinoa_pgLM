...
dataset_split="2000"
filename="test.csv"
time_str="20251022202559"
step="158796"
gpu_id=-1
export CUDA_VISIBLE_DEVICES="0,1,2,3"
python predict_v2.py \
    --input_file /home/quinoa/work/LucaOneTasks/predicts/QuinoaAltitude_SV/gene/multi_class/infertest/2000.csv \
    --llm_truncation_seq_length 4096 \
    --model_path .. \
    --save_path ../predicts/${dataset_name}/${dataset_type}/${task_type}/infertest/${dataset_split}/results_${filename} \
    --output_attention_pooling_scores_dirpath ../predicts/${dataset_name}/${dataset_type}/${task_type}/infertest/${dataset_split}/attention_pooling_scores/ \
    --emb_dir ../predicts/${dataset_name}/${dataset_type}/${task_type}/infertest/${dataset_split}/seq_embedding/ \
    ...
    --gpu_id ${gpu_id} \
    --topk 4 \
    --output_matrix_dirpath ../predicts/${dataset_name}/${dataset_type}/${task_type}/infertest/${dataset_split}/matrix/ \
    --output_classification_vector_dirpath ../predicts/${dataset_name}/${dataset_type}/${task_type}/infertest/${dataset_split}/classification_vector/ \
    --output_logits_dirpath ../predicts/${dataset_name}/${dataset_type}/${task_type}/infertest/${dataset_split}/logits/ \
