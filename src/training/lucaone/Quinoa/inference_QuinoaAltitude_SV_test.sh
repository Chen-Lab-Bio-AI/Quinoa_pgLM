...
python predict_v2.py \
    ...
    --print_per_num 10000 \
    --gpu_id ${gpu_id} \
    --output_matrix_dirpath ../predicts/${dataset_name}/${dataset_type}/${task_type}/${dataset_split}/matrix/  \
    --output_classification_vector_dirpath ../predicts/${dataset_name}/${dataset_type}/${task_type}/${dataset_split}/classification/
