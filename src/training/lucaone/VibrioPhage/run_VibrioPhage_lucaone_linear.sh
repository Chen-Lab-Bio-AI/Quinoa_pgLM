...
# for dataset
DATASET_NAME="VibrioPhage"
DATASET_TYPE="protein_protein"

# for task
TASK_TYPE="binary_class"
TASK_LEVEL_TYPE="seq_level"
LABEL_TYPE="VibrioPhage"

# for input
## here only embedding matrix-channel
## channels: seq_vs_seq, matrix_vs_matri
INPUT_TYPE="matrix_vs_matrix"
INPUT_MODE="pair"
TRUNC_TYPE="right"

# for model
MODEL_TYPE="lucasetpair_heter"
CONFIG_NAME="lucasetpair_heter_config.json"
FUSION_TYPE="concat"
dropout_prob=0.1
fc_size=256
