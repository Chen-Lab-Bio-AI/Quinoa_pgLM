...
## seq_vs_seq, seq_vs_vector, seq_vs_matrix, vector_vs_vector, vector_vs_matrix, matrix_vs_matrix, matrix_express_vs_matrix
INPUT_TYPE="vector_vs_matrix"
INPUT_MODE="pair"
TRUNC_TYPE="right"
